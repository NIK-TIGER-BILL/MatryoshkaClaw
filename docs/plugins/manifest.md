...
read_when:
  - You are building a MatryoshkaClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (matryoshka.plugin.json)

Every plugin **must** ship a `matryoshka.plugin.json` file in the **plugin root**.
MatryoshkaClaw uses this manifest to validate configuration **without executing plugin
