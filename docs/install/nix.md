---
summary: "Install MatryoshkaClaw declaratively with Nix"
read_when:
...
MatryoshkaClaw supports a **Nix mode** that makes configuration deterministic and disables auto-install flows.
...
MatryoshkaClaw reads JSON5 config from `OPENCLAW_CONFIG_PATH` and stores mutable data in `OPENCLAW_STATE_DIR`.
...
[`scripts/package-mac-app.sh`](https://github.com/NIK-TIGER-BILL/MatryoshkaClaw/blob/main/scripts/package-mac-app.sh) copies this template into the app bundle and patches dynamic fields
