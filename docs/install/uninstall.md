---
summary: "Uninstall MatryoshkaClaw completely (CLI, service, state, workspace)"
read_when:
  - You want to remove MatryoshkaClaw from a machine
...
Default task name is `MatryoshkaClaw Gateway` (or `MatryoshkaClaw Gateway (<profile>)`).
