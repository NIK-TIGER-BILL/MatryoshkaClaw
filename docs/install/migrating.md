---
summary: "Move (migrate) a MatryoshkaClaw install from one machine to another"
read_when:
  - You are moving MatryoshkaClaw to a new laptop/server
  - You want to preserve sessions, auth, and channel logins (WhatsApp, etc.)
title: "Migration Guide"
---

# Migrating MatryoshkaClaw to a new machine

This guide migrates a MatryoshkaClaw Gateway from one machine to another **without redoing onboarding**.
...
### Step 1 — Install MatryoshkaClaw on the new machine
...
- `matryoshka status` shows the gateway running
