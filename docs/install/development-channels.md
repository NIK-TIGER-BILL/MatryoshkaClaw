...
MatryoshkaClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, MatryoshkaClaw also aligns
the install method:
...
When you switch channels with `matryoshka update`, MatryoshkaClaw also syncs plugin sources:
