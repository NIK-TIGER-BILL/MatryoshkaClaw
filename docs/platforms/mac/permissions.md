...
- Same path: run the app from a fixed location (for MatryoshkaClaw, `dist/MatryoshkaClaw.app`).
...
Workaround: move files into the MatryoshkaClaw workspace (`~/.openclaw/workspace`) if you want to avoid per-folder grants.
