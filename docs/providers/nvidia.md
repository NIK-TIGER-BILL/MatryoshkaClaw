---
summary: "Use NVIDIA's OpenAI-compatible API in MatryoshkaClaw"
read_when:
  - You want to use NVIDIA models in MatryoshkaClaw
...
matryoshka onboard --auth-choice skip
matryoshka models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
