---
summary: "Use Qianfan's unified API to access many models in MatryoshkaClaw"
read_when:
...
3. MatryoshkaClaw installed on your system
...
4. Copy the API key for use with MatryoshkaClaw

## CLI setup

```bash
matryoshka onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [MatryoshkaClaw Configuration](/gateway/configuration)
