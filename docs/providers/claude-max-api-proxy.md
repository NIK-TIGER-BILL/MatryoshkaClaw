...
You can point MatryoshkaClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or MatryoshkaClaw
...
- [Anthropic provider](/providers/anthropic) - Native MatryoshkaClaw integration with Claude setup-token or API keys
