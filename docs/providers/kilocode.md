---
summary: "Use Kilo Gateway's unified API to access many models in MatryoshkaClaw"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in MatryoshkaClaw
---
...
```bash
matryoshka onboard --kilocode-api-key <key>
```
...
MatryoshkaClaw dynamically discovers available models from the Kilo Gateway at startup. Use
