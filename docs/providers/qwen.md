---
summary: "Use Qwen OAuth (free tier) in MatryoshkaClaw"
read_when:
  - You want to use Qwen with MatryoshkaClaw
...
If you already logged in with the Qwen Code CLI, MatryoshkaClaw will sync credentials
