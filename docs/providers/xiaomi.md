---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with MatryoshkaClaw"
read_when:
  - You want Xiaomi MiMo models in MatryoshkaClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). MatryoshkaClaw uses
