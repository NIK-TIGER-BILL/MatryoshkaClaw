---
summary: "Use Synthetic's Anthropic-compatible API in MatryoshkaClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. MatryoshkaClaw registers it as the
...
Note: MatryoshkaClaw's Anthropic client appends `/v1` to the base URL, so use
