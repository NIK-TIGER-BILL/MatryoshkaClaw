...
summary: 使用 Ansible、Tailscale VPN 和防火墙隔离进行自动化、加固的 MatryoshkaClaw 安装
title: Ansible
x-i18n:
...
将 MatryoshkaClaw 部署到生产服务器的推荐方式是通过 **[openclaw-ansible](https://github.com/matryoshka/openclaw-ansible)** — 一个安全优先架构的自动化安装程序。
...
> **📦 完整指南：[github.com/matryoshka/openclaw-ansible](https://github.com/matryoshka/openclaw-ansible)**
>
...
# 2. 克隆仓库
git clone https://github.com/matryoshka/openclaw-ansible.git
cd openclaw-ansible
...
# 或直接运行（然后手动执行 /tmp/matryoshka-setup.sh）
# ansible-playbook playbook.yml --ask-become-pass
```

## 更新 MatryoshkaClaw

Ansible 安装程序设置 MatryoshkaClaw 为手动更新。标准更新流程参见[更新](/install/updating)。
...
- [安全架构](https://github.com/matryoshka/openclaw-ansible/blob/main/docs/security.md)
- [技术详情](https://github.com/matryoshka/openclaw-ansible/blob/main/docs/architecture.md)
- [故障排除指南](https://github.com/matryoshka/openclaw-ansible/blob/main/docs/troubleshooting.md)

## 相关内容

- [openclaw-ansible](https://github.com/matryoshka/openclaw-ansible) — 完整部署指南
