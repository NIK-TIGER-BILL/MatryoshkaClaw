---
summary: "Frequently asked questions about MatryoshkaClaw setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up MatryoshkaClaw?](#whats-the-recommended-way-to-install-and-set-up-matryoshka)
  ...
  - [Windows install says git not found or matryoshka not recognized](#windows-install-says-git-not-found-or-matryoshka-not-recognized)
  ...
  - [How do I install MatryoshkaClaw on Linux?](#how-do-i-install-matryoshka-on-linux)
  - [How do I install MatryoshkaClaw on a VPS?](#how-do-i-install-matryoshka-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask MatryoshkaClaw to update itself?](#can-i-ask-matryoshka-to-update-itself)
  ...
  - [If I buy a Mac mini to run MatryoshkaClaw, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-openclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different MatryoshkaClaw instances?](#can-multiple-people-use-one-whatsapp-number-with-different-matryoshka-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run MatryoshkaClaw on a dedicated machine?](#how-important-is-it-to-run-openclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run MatryoshkaClaw in a VM and what are the requirements](#can-i-run-openclaw-in-a-vm-and-what-are-the-requirements)
- [What is MatryoshkaClaw?](#what-is-matryoshka)
  - [What is MatryoshkaClaw, in one paragraph?](#what-is-matryoshka-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for MatryoshkaClaw](#what-are-the-top-five-everyday-use-cases-for-matryoshka)
  - [Can MatryoshkaClaw help with lead gen outreach ads and blogs for a SaaS](#can-matryoshka-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can MatryoshkaClaw run tasks on a schedule or continuously in the background?](#can-matryoshka-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with MatryoshkaClaw saved locally?](#is-all-data-used-with-matryoshka-saved-locally)
  - [Where does MatryoshkaClaw store its data?](#where-does-matryoshka-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall MatryoshkaClaw?](#how-do-i-completely-uninstall-matryoshka)
...
- [Config basics](#config-basics)
  ...
  - [Can the MatryoshkaClaw browser run headless?](#can-the-openclaw-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two MatryoshkaClaw instances talk to each other (local + VPS)?](#can-two-matryoshka-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does MatryoshkaClaw load environment variables?](#how-does-matryoshka-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of MatryoshkaClaw instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-matryoshka-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset MatryoshkaClaw but keep it installed?](#how-do-i-completely-reset-matryoshka-but-keep-it-installed)
  ...
  - [Why doesn't MatryoshkaClaw reply in a group?](#why-doesnt-matryoshka-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do MatryoshkaClaw, Flawd, and Krill use for models?](#what-do-matryoshka-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `matryoshka gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-openclaw-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `matryoshka gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-openclaw-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run MatryoshkaClaw in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-openclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart MatryoshkaClaw?](#i-closed-my-terminal-on-windows-how-do-i-restart-matryoshka)
  ...
  - [ELI5: `matryoshka gateway restart` vs `matryoshka gateway`](#eli5-openclaw-gateway-restart-vs-openclaw-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose MatryoshkaClaw to inbound DMs?](#is-it-safe-to-expose-matryoshka-to-inbound-dms)
...
7. **Gateway snapshot**
   ...
   ```bash
   matryoshka health --json
   matryoshka health --verbose   # shows the target URL + config path on errors
   ```
...
This installs MatryoshkaClaw **from a git checkout**, so the agent can read the code + docs and
...
```bash
matryoshka status
matryoshka models status
matryoshka doctor
```

What they do:

- `matryoshka status`: quick snapshot of gateway/agent health + basic config.
- `matryoshka models status`: checks provider auth + model availability.
- `matryoshka doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `matryoshka status --all`, `matryoshka logs --follow`,
`matryoshka gateway status`, `matryoshka health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up MatryoshkaClaw
...
If you don't have a global install yet, run it via `pnpm matryoshka onboard`.
...
- Retrieve it from the gateway host: `matryoshka config get gateway.auth.token` (or generate one: `matryoshka doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `matryoshka gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `matryoshka gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install MatryoshkaClaw on the new machine.
2. Copy `$OPENCLAW_STATE_DIR` (default: `~/.openclaw`) from the old machine.
3. Copy your workspace (default: `~/.openclaw/workspace`).
4. Run `matryoshka doctor` and restart the Gateway service.
...
Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-matryoshka-store-its-data),
...
### Windows install says git not found or matryoshka not recognized
...
**2) matryoshka is not recognized after install**
...
If you still reproduce this on latest MatryoshkaClaw, track/report it in:
...
### How do I install MatryoshkaClaw on Linux
...
### How do I install MatryoshkaClaw on a VPS
...
### Can I ask MatryoshkaClaw to update itself
...
```bash
matryoshka update
matryoshka update status
matryoshka update --channel stable|beta|dev
matryoshka update --tag <dist-tag|version>
matryoshka update --no-restart
```

If you must automate from an agent:

```bash
matryoshka update --yes --no-restart
matryoshka gateway restart
```
...
`matryoshka onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run MatryoshkaClaw with **API keys** (Anthropic/OpenAI/others) or with
...
OpenAI Codex OAuth is explicitly supported for external tools like MatryoshkaClaw.
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `matryoshka models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `matryoshka models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `matryoshka models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. MatryoshkaClaw no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so MatryoshkaClaw can keep replying while a provider is rate-limited.
...
MatryoshkaClaw supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.4` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. MatryoshkaClaw fully supports **OpenAI Code (Codex) subscription OAuth**.
OpenAI explicitly allows subscription OAuth usage in external tools/workflows
like MatryoshkaClaw. The onboarding wizard can run the OAuth flow for you.
...
1. Enable the plugin: `matryoshka plugins enable google-gemini-cli-auth`
2. Login: `matryoshka models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. MatryoshkaClaw needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.5 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. MatryoshkaClaw runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run MatryoshkaClaw can I connect it to my MacBook Pro
...
- Use `matryoshka nodes status` / `matryoshka nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but MatryoshkaClaw authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `matryoshka logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different MatryoshkaClaw instances
...
If you run MatryoshkaClaw via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the MatryoshkaClaw code install. Your state
...
**MatryoshkaClaw-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run MatryoshkaClaw on a dedicated machine
...
MatryoshkaClaw is lightweight. For a basic Gateway + one chat channel:
...
### Can I run MatryoshkaClaw in a VM and what are the requirements
...
## What is MatryoshkaClaw?

### What is MatryoshkaClaw in one paragraph

MatryoshkaClaw is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

MatryoshkaClaw is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for MatryoshkaClaw
...
### Can MatryoshkaClaw help with lead gen outreach ads and blogs for a SaaS
...
MatryoshkaClaw draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

MatryoshkaClaw is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use MatryoshkaClaw when you
...
Yes. Add extra directories via `skills.load.extraDirs` in `~/.openclaw/openclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.openclaw/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which MatryoshkaClaw treats as `<workspace>/skills`.
...
```bash
matryoshka cron run <jobId> --force
matryoshka cron runs --id <jobId> --limit 50
```
...
### Can MatryoshkaClaw run tasks on a schedule or continuously in the background
...
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. MatryoshkaClaw can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.openclaw/skills`) to allow Linux:
   ...
   metadata: { "matryoshka": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured MatryoshkaClaw workspace); MatryoshkaClaw treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.openclaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
MatryoshkaClaw memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

MatryoshkaClaw also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, MatryoshkaClaw auto-selects a provider when it
...
configured and present, MatryoshkaClaw
...
### Is all data used with MatryoshkaClaw saved locally

No - **MatryoshkaClaw's state is local**, but **external services still see what you send them**.
...
### Where does MatryoshkaClaw store its data
...
Legacy single-agent path: `~/.openclaw/agent/*` (migrated by `matryoshka doctor`).
...
### How do I completely uninstall MatryoshkaClaw
...
`workspace` to the repo root. The MatryoshkaClaw repo is just source code; keep the
...
MatryoshkaClaw reads an optional **JSON5** config from `$OPENCLAW_CONFIG_PATH` (default: `~/.openclaw/openclaw.json`):
...
MatryoshkaClaw enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `matryoshka doctor --generate-gateway-token`.
...
- `default`: uses `All your chats, one MatryoshkaClaw.` every time.
...
**Recommended:** run `matryoshka configure --section web` and choose a provider.
...
### Can the MatryoshkaClaw browser run headless
...
- Gateway is running: `matryoshka gateway status`
- Gateway health: `matryoshka status`
- Channel health: `matryoshka channels status`
...
### Can two MatryoshkaClaw instances talk to each other local VPS
...
`matryoshka agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
matryoshka agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- If you have no backup, re-run `matryoshka doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `matryoshka config set` for small changes.
- Use `matryoshka configure` for interactive edits.
...
```bash
matryoshka gateway --tailscale serve
```
...
### How does MatryoshkaClaw load environment variables

MatryoshkaClaw reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:
...
`matryoshka models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means MatryoshkaClaw won't load
...
### Is there a way to make a team of MatryoshkaClaw instances one CEO and many agents
...
### How do I completely reset MatryoshkaClaw but keep it installed
...
```bash
matryoshka reset --scope full --yes --non-interactive
```
...
- Dev reset: `matryoshka gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), MatryoshkaClaw skips the heartbeat run to save API calls.
...
No. MatryoshkaClaw runs on **your own account**, so if you're in the group, MatryoshkaClaw can see it.
...
```bash
matryoshka directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't MatryoshkaClaw reply in a group
...
- Use `matryoshka doctor` to spot stray workspaces and profile mismatches.
...
MatryoshkaClaw's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, MatryoshkaClaw currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `matryoshka models set ...` (updates just model config)
- `matryoshka configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.openclaw/openclaw.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `matryoshka doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do MatryoshkaClaw, Flawd, and Krill use for models

- These deployments can differ and may change over time; there is no fixed provider recommendation.
- Check the current runtime setting on each gateway with `matryoshka models status`.
...
Yes. MatryoshkaClaw ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
- Run `matryoshka agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so MatryoshkaClaw can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  ...
  - Legacy: `~/.openclaw/agent/*` (migrated by `matryoshka doctor`)
...
- **Sanity-check model/auth status**
  - Use `matryoshka models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `matryoshka models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `matryoshka models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.openclaw/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    matryoshka models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), MatryoshkaClaw will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: MatryoshkaClaw now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
MatryoshkaClaw uses provider-prefixed IDs like:
...
MatryoshkaClaw may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `matryoshka models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
matryoshka models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
matryoshka models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
matryoshka models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
matryoshka models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

MatryoshkaClaw supports both:
...
### Why does matryoshka gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `matryoshka gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does matryoshka gateway status show Config cli and Config service different
...
```bash
matryoshka gateway install --force
```
...
MatryoshkaClaw enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `matryoshka gateway --port <port>`.

### How do I run MatryoshkaClaw in remote mode client connects to a Gateway elsewhere
...
- `matryoshka gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- Fastest: `matryoshka dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `matryoshka doctor --generate-gateway-token`.
...
- If mismatch persists after the one retry, rotate/re-approve the paired device token:
  - `matryoshka devices list`
  - `matryoshka devices rotate --device <id> --role operator`
- Still stuck? Run `matryoshka status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- Use `matryoshka --profile <name> …` per instance (auto-creates `~/.openclaw-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `matryoshka --profile <name> gateway install`.

Profiles also suffix service names (`ai.openclaw.<profile>`; legacy `com.openclaw.*`, `openclaw-gateway-<profile>.service`, `MatryoshkaClaw Gateway (<profile>)`).
...
```
matryoshka tui --url ws://<host>:18789 --token <token>
```
...
- Windows: `schtasks /Query /TN "MatryoshkaClaw Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `matryoshka gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart MatryoshkaClaw
...
1. Is the Gateway running? `matryoshka gateway status`
2. Is the Gateway healthy? `matryoshka status`
3. Does the UI have the right token? `matryoshka dashboard`
...
```bash
matryoshka channels status
matryoshka channels logs --channel telegram
```
...
### ELI5 matryoshka gateway restart vs matryoshka gateway

- `matryoshka gateway restart`: restarts the **background service** (launchd/systemd).
- `matryoshka gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `matryoshka gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [MatryoshkaClaw assistant setup](/start/matryoshka) and [Agent send](/tools/agent-send).

CLI sending:

```bash
matryoshka message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose MatryoshkaClaw to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `matryoshka pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `matryoshka pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `matryoshka doctor` to surface risky DM policies.
...
```bash
matryoshka pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. MatryoshkaClaw only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
matryoshka pairing approve whatsapp <code>
```

List pending requests:

```bash
matryoshka pairing list whatsapp
```
...
MatryoshkaClaw blocks **cross-provider** messaging by default. If a tool call is bound
