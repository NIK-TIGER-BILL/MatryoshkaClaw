...
If you don’t have a global install yet, run the CLI via `pnpm matryoshka ...`.
...
## Raw stream logging (MatryoshkaClaw)

MatryoshkaClaw can log the **raw assistant stream** before any filtering/formatting.
