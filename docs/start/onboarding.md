---
summary: "First-run onboarding flow for MatryoshkaClaw (macOS app)"
read_when:
...
- By default, MatryoshkaClaw is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give MatryoshkaClaw">
...
<Step title="CLI">
  ...
  The app can install the global `matryoshka` CLI via npm/pnpm so terminal
