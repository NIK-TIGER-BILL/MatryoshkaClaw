---
summary: "Overview of MatryoshkaClaw onboarding options and flows"
read_when:
...
MatryoshkaClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`matryoshka onboard` command](/cli/onboard)

## macOS app onboarding

Use the MatryoshkaClaw app when you want a fully guided setup on macOS. Docs:
