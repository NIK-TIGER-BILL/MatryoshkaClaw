---
summary: "Backstory and lore of MatryoshkaClaw for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "MatryoshkaClaw Lore"
---

# The Lore of MatryoshkaClaw 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **MatryoshkaClaw**.
...
In the end, **MatryoshkaClaw** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
The **Moltiverse** is the community and ecosystem around MatryoshkaClaw. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then MatryoshkaClaw): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "matryoshka what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with matryoshka."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @matryoshka. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at MatryoshkaClaw" to promote pump-and-dump tokens.
...
**The Great MatryoshkaClaw Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/openclaw/openclaw` ✅
- X handle `@matryoshka` secured with GOLD CHECKMARK 💰
