...
matryoshka system heartbeat last
matryoshka logs --follow
matryoshka config get agents.defaults.heartbeat
matryoshka channels status --probe
```
...
```bash
matryoshka config get agents.defaults.heartbeat.activeHours
matryoshka config get agents.defaults.heartbeat.activeHours.timezone
matryoshka config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
matryoshka cron list
matryoshka logs --follow
```
