---
summary: "Synology Chat webhook setup and MatryoshkaClaw config"
read_when:
  - Setting up Synology Chat with MatryoshkaClaw
...
```bash
matryoshka plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your MatryoshkaClaw gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in MatryoshkaClaw.
...
- Pairing approvals work with:
  - `matryoshka pairing list synology-chat`
  - `matryoshka pairing approve synology-chat <CODE>`
...
```bash
matryoshka message send --channel synology-chat --target 123456 --text "Hello from MatryoshkaClaw"
matryoshka message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
