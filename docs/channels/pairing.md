...
read_when:
  ...
  - Reviewing MatryoshkaClaw security posture
title: "Pairing"
---

# Pairing

“Pairing” is MatryoshkaClaw’s explicit **owner approval** step.
...
3. On your phone, open the MatryoshkaClaw iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `matryoshka nodes pending/approve`) is a
