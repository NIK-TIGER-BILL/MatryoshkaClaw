...
- Install via CLI: `matryoshka plugins install @matryoshka/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `matryoshka plugins install ./extensions/zalo`
   - From npm (if published): `matryoshka plugins install @matryoshka/zalo`
...
- Approve via:
  - `matryoshka pairing list zalo`
  - `matryoshka pairing approve zalo <CODE>`
...
- Example: `matryoshka message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `matryoshka channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `matryoshka logs --follow`
