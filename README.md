...
```
✅ Node.js v22.1.0 найден. Бабушка одобряет.
✅ Токен Max настроен. Суверенный мессенджер готов к работе. 🪆
⚠️  GigaChat не настроен. Установите GIGACHAT_CREDENTIALS для российского LLM.
✅ Шлюз запущен. Очередь принимает заявки.
