...
<details>
<summary>Требования, диагностика и ручная установка</summary>
...
**"Это безопасно?"** — Безопаснее, чем Excel-файл с паролями на рабочем столе замминистра.

**"Это лучше ChatGPT?"** — Для отчёта перед руководством — однозначно да.

**"Сколько стоит?"** — Бесплатно. Мы же опенсорс. Да, мы тоже в шоке.

**"А если сломается?"** — `matryoshka doctor`. Если не поможет — `matryoshka babushka`. Бабушка всегда поможет.

**"Можно ли показать президенту?"** — Можно. Но мы не несём ответственности за последствия.
