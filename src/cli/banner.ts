...
const LOBSTER_ASCII = [
  "    __  ___      __                        __    __         ________              ",
  "   /  |/  /___ _/ /________  ______  _____/ /_  / /______ _/ ____/ /___ __      __",
  "  / /|_/ / __ `/ __/ ___/ / / / __ \\/ ___/ __ \\/ //_/ __ `/ /   / / __ `/ | /| / /",
  " / /  / / /_/ / /_/ /  / /_/ / /_/ (__  ) / / / ,< / /_/ / /___/ / /_/ /| |/ |/ / ",
  "/_/  /_/\\__,_/\\__/_/   \\__, /\\____/____/_/ /_/_/|_|\\__,_/\\____/_/\\__,_/ |__/|__/  ",
  "                      /____/                                                      ",
  " ",
];
...
export function formatCliBannerArt(options: BannerOptions = {}): string {
  ...
  const colored = LOBSTER_ASCII.map((line) => {
    if (line.includes("MATRYOSHKACLAW")) {
      return (
        theme.muted("              ") +
        theme.accent("🦞") +
        theme.info(" MATRYOSHKACLAW ") +
        theme.accent("🦞")
      );
    }
